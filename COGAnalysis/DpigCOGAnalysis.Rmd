...
New table "GCsbyCOG_CorevsAcc" in wide format. Total GCs for each COG category calculated, as well as % of GCs in the "Accessory" and "Soft/Core" relative to each category. The ratio between the number of GC in the "Accessory" vs. the "Soft/Core" is calculated for each COG:
```{r}
