...
In order to use the desired Python environment we need to define the path in the .Rprofile for this project. 
```{r, eval=FALSE}
file.edit(".Rprofile")
```
...
DNA and Protein Sequences for the Anvio GCs identified as Transposases/Retrons:
```{bash, eval=FALSE}
cd ..
