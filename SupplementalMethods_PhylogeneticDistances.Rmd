...
bibliography: references/references_PhylogeneticDistances.bib
link-citations: true
---
...
Using the R package [`harrietr`](https://cran.r-project.org/web/packages/harrietr/README.html), we can calculate the evolutionary pairwise SNP distances in this phylogeny
```{r, eval = TRUE}
